...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/services.DeviceTokenResponse"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/device-tokens/deactivate": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Токен деактивирован",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.RegisterDeviceTokenRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "services.RegisterDeviceTokenRequest": {
            "type": "object",
            "required": [
                "device_token",
                "platform"
